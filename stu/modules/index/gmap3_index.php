           ...
           <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="box box-danger">
                ...
                <!-- /.box-header -->
							...
							<div class='title'>
							<?php
							$res['marker'] = $db->select_query("SELECT * FROM ".TB_STUDENT." where stu_area='".$_SESSION['stu_area']."'  and stu_code='".$_SESSION['stu_school']."' group by stu_class order by stu_class"); 
...
//	function initMap(markers) {
        $('#map_canvas').gmap3({
                ...
                values: [
					<?php
					//$db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
					$strSQL = $db->select_query("SELECT * FROM ".TB_STUDENT." as a ,".TB_CLASS." as b  where a.stu_area='".$_SESSION['stu_area']."' and a.stu_code='".$_SESSION['stu_school']."' and b.class_id=a.stu_class order by a.stu_id"); 
					//$resultArray = array();
