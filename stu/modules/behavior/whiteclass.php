...
if($op=='del'){
		...
		$del .=$db->del(TB_WHITECLTAIL," whcl_area='".$_SESSION['stu_area']."' and whcl_code='".$_SESSION['stu_school']."' and whcl_id='".$_GET['whcl_id']."' ");
		if($del){
...
if($op=='cldel'){
		...
		$del .=$db->del(TB_WHITECLTAIL," whcl_area='".$_SESSION['stu_area']."' and whcl_code='".$_SESSION['stu_school']."' and whcl_id='".$_GET['whcl_id']."' and whcl_stu='".$_GET['stu_id']."' ");
		if($del){
		$success=_text_report_del_ok;
		} else {
		$error_warning=_text_report_del_fail;
...
if($op=='delall'){
		...
		while(list($key, $value) = each ($_POST['selected'])){
			...
			$del .=$db->del(TB_WHITECLTAIL," whcl_area='".$_SESSION['stu_area']."' and whcl_code='".$_SESSION['stu_school']."' and whcl_id='".$value."' ");
//			$db->closedb ();
		}
		if($del){
		$success=_text_report_del_ok;
...
if($op=='cldelall'){
		...
		while(list($key, $value) = each ($_POST['selected'])){
			...
			$del .=$db->del(TB_WHITECLTAIL," whcl_area='".$_SESSION['stu_area']."' and whcl_code='".$_SESSION['stu_school']."' and whcl_stu='".$value."' and whcl_id='".$_GET['whcl_id']."' ");
//			$db->closedb ();
		}
		if($del){
		$success=_text_report_del_ok;
...
<?php
		...
		@$res['best'] = $db->select_query("SELECT * FROM ".TB_WHITECLTAIL." WHERE whcl_area='".$_SESSION['stu_area']."' and whcl_code='".$_SESSION['stu_school']."' and whcl_stu='".$_GET['stu_id']."'"); 
...
@$res['bad'] = $db->select_query("SELECT *,count(whcl_stu) as STU FROM ".TB_WHITECLTAIL." WHERE whcl_class='".$_SESSION['stu_class']."' and whcl_gr='".$_SESSION['stu_cn']."'  and whcl_area='".$_SESSION['stu_area']."' and whcl_code='".$_SESSION['stu_school']."' group by whcl_class"); 
 @$arr['bad']= $db->fetch(@$res['bad']);
@$res['cl'] = $db->select_query("SELECT * FROM ".TB_CLASS_GROUP." ,".TB_CLASS." WHERE clg_group='".$_SESSION['stu_class']."' and clg_name='".$_SESSION['stu_cn']."' and class_id=clg_group "); 
...
?>
     ...
     <button type="button" class="close" data-dismiss="alert">X</button>
	  ...
	  <?php
		...
		@$res['num'] = $db->select_query("SELECT *,count(whcl_stu) as CO FROM ".TB_WHITECLTAIL." as a, ".TB_STUDENT." as b where whcl_class='".$_SESSION['stu_class']."' and whcl_gr='".$_SESSION['stu_cn']."' and whcl_area='".$_SESSION['stu_area']."' and whcl_code='".$_SESSION['stu_school']."' and stu_class='".$_SESSION['stu_class']."' and stu_cn='".$_SESSION['stu_cn']."' and whcl_stu=stu_id group by whcl_stu order by CO desc,stu_class,stu_id "); 
		@$rows['num'] = $db->rows(@$res['num']);
		if(@$rows['num']) {
		?>
