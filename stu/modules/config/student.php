...
<?php if($op=='edit' and $action==''){
		...
		@$res['user'] = $db->select_query("SELECT * FROM ".TB_STUDENT." WHERE stu_area='".$_SESSION['stu_area']."' and stu_code='".$_SESSION['stu_school']."' and stu_class='".$_SESSION['stu_class']."' and  stu_cn='".$_SESSION['stu_cn']."' and stu_id='".$_GET['stu_id']."'"); 
...
//twitter bootstrap script
 $("button#submitForm").click(function(){
			$.ajax({
			type: "POST",
			url: "../stu/modules/config/processstudent.php",
...
@$res['user'] = $db->select_query("SELECT * FROM ".TB_STUDENT." where stu_id='".$_SESSION['stu_pwd']."' and stu_class='".$_SESSION['stu_class']."' and  stu_cn='".$_SESSION['stu_cn']."' order by stu_class,stu_id"); 
@$arr['user'] = $db->fetch(@$res['user']);
...
?>
		...
		<div align="right" >
		<div class="form-group">
		<a href="index.php?name=config&file=student&op=edit&stu_id=<?php echo @$_SESSION['stu_pwd']; ?>&route=<?php echo $route;?>" class="btn bg-aqua btn-flat btn-sm"><i class="fa fa-edit "></i>&nbsp;แก้ไขข้อมูล</a>
		</div>
		</div>
