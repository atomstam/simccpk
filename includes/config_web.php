...
define('_text_footer3', 'โทร. 089946997 website : https://sims.kut.ac.th  email : atom3123@gmail.com');
...
define('YEAR','2564');
define('YEAR_LAST1','2563');
define('YEAR_LAST2','2562');
define('YEAR_LAST3','2561');
define('YEAR_LAST4','2560');


define('WEB_PATH', '/home/stdkut/public_html');
//define('WEB_URL', 'https://sims.kut.ac.th');
//define('WEB_URLS', 'https://sims.kut.ac.th');
define('WEB_EMAIL', 'atom3123@gmail.com');
//define('WEB_URL_IMG', 'https://sims.kut.ac.th/img/');
//define('WEB_URL_IMG_ADMIN', 'https://sims.kut.ac.th/img/admin/');
//define('WEB_URL_IMG_PERSON', 'https://sims.kut.ac.th/img/person/');
//define('WEB_URL_IMG_STU', 'https://sims.kut.ac.th/img/stu/');
//define('WEB_URL_IMG_USER', 'https://sims.kut.ac.th/img/user/');
//define('WEB_URL_IMG_MAG', 'https://sims.kut.ac.th/img/mag/');
//define('WEB_URL_IMG_ICON', 'https://sims.kut.ac.th/img/icon/');
//define('WEB_URL_IMG_MOTOR', 'https://sims.kut.ac.th/img/motor/');
...
//define('WEB_URL_IMG_NEWS', 'https://sims.kut.ac.th/img/news/');
define('WEB_PATH_IMG_NEWS', '/home/stdkut/public_html/img/news/');
//define('WEB_URL_IMG_NEWS_RAN', 'https://sims.kut.ac.th/img/news/');
define('WEB_PATH_IMG_NEWS_RAN', '/home/stdkut/public_html/img/news/');

//define('WEB_URL_IMG_SCHOOL','https://sims.kut.ac.th/img/school/');
