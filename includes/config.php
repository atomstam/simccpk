...
define('_text_footer3', 'โทร. 089946997 website : https://sim.ccpk.ac.th  email : atom3123@gmail.com');
...
define('WEB_URL', 'https://sim.ccpk.ac.th');
define('WEB_URLS', 'https://sim.ccpk.ac.th');
define('WEB_EMAIL', 'atom3123@gmail.com');
define('WEB_EMAIL_PASS', '3123tomtam');
define('WEB_URL_IMG', 'https://sim.ccpk.ac.th/img/');
define('WEB_URL_IMG_ADMIN', 'https://sim.ccpk.ac.th/img/admin/');
define('WEB_URL_IMG_PERSON', 'https://sim.ccpk.ac.th/img/person/');
define('WEB_URL_IMG_STU', 'https://sim.ccpk.ac.th/img/stu/');
define('WEB_URL_IMG_USER', 'https://sim.ccpk.ac.th/img/user/');
define('WEB_URL_IMG_MAG', 'https://sim.ccpk.ac.th/img/mag/');
define('WEB_URL_IMG_ICON', 'https://sim.ccpk.ac.th/img/icon/');
define('WEB_URL_IMG_MOTOR', 'https://sim.ccpk.ac.th/img/motor/');
...
define('WEB_URL_IMG_UPLOAD', 'https://sim.ccpk.ac.th/uploads/');

define('WEB_URL_IMG_NEWS', 'https://sim.ccpk.ac.th/img/news/');
define('WEB_PATH_IMG_NEWS', '/home/stdkut/public_html/img/news/');
define('WEB_URL_IMG_NEWS_RAN', 'https://sim.ccpk.ac.th/img/news/');
define('WEB_PATH_IMG_NEWS_RAN', '/home/stdkut/public_html/img/news/');

define('WEB_URL_IMG_SCHOOL','https://sim.ccpk.ac.th/img/school/');
