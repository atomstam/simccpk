...
define('_text_footer2', 'พัฒนาโดย นายชัดสกร พิกุลทอง ผู้อำนวยการโรงเรียนชื่นชมพิทยาคาร อำเภอชื่นชม จังหวัดมหาสารคาม');
define('_text_footer3', 'โทร. 089946997 website : http://localhost/sim_kut  email : atom3123@gmail.com');
...
define('YEAR','2565');
define('YEAR_LAST1','2564');
define('YEAR_LAST2','2563');
define('YEAR_LAST3','2562');
define('YEAR_LAST4','2561');


define('WEB_PATH', 'D:\xampp\htdocs\sim_kut');
define('WEB_URL', 'http://localhost/sim_kut');
define('WEB_URLS', 'http://localhost/sim_kut');
define('WEB_EMAIL', 'atom3123@gmail.com');
define('WEB_EMAIL_PASS', '3123tomtam');
define('WEB_URL_IMG', 'http://localhost/sim_kut/img/');
define('WEB_URL_IMG_ADMIN', 'http://localhost/sim_kut/img/admin/');
define('WEB_URL_IMG_PERSON', 'http://localhost/sim_kut/img/person/');
define('WEB_URL_IMG_STU', 'http://localhost/sim_kut/img/stu/');
define('WEB_URL_IMG_USER', 'http://localhost/sim_kut/img/user/');
define('WEB_URL_IMG_MAG', 'http://localhost/sim_kut/img/mag/');
define('WEB_URL_IMG_ICON', 'http://localhost/sim_kut/img/icon/');
define('WEB_URL_IMG_MOTOR', 'http://localhost/sim_kut/img/motor/');
define('WEB_PATH_IMG_ADMIN', 'D:\xampp\htdocs\sim_kut/img/admin/');
define('WEB_PATH_IMG_PERSON', 'D:\xampp\htdocs\sim_kut/img/person/');
define('WEB_PATH_IMG_STU', 'D:\xampp\htdocs\sim_kut/img/stu/');
define('WEB_PATH_IMG_USER', 'D:\xampp\htdocs\sim_kut/img/user/');
define('WEB_PATH_IMG_MAG', 'D:\xampp\htdocs\sim_kut/img/mag/');
define('WEB_PATH_IMG_ICON', 'D:\xampp\htdocs\sim_kut/img/icon/');
define('WEB_PATH_IMG_MOTOR', 'D:\xampp\htdocs\sim_kut/img/motor/');
define('WEB_PATH_UPLOAD', 'D:\xampp\htdocs\sim_kut/uploads/');
define('WEB_URL_IMG_UPLOAD', 'http://localhost/sim_kut/uploads/');

define('WEB_URL_IMG_NEWS', 'http://localhost/sim_kut/img/news/');
define('WEB_PATH_IMG_NEWS', 'D:\xampp\htdocs\sim_kut/img/news/');
define('WEB_URL_IMG_NEWS_RAN', 'http://localhost/sim_kut/img/news/');
define('WEB_PATH_IMG_NEWS_RAN', 'D:\xampp\htdocs\sim_kut/img/news/');

define('WEB_URL_IMG_SCHOOL','http://localhost/sim_kut/img/school/');
define('WEB_PATH_IMG_SCHOOL','D:\xampp\htdocs\sim_kut/img/school/');

//define('WEB_PATH', '/usr/local/www/apache22/data/maxtom');
//define('WEB_URL', 'https://thaiesan.sytes.net/maxtom');
//define('WEB_EMAIL', 'atom3123@gmail.com');
//define('WEB_URL_IMG', 'https://thaiesan.sytes.net/maxtom/img/');
//define('WEB_URL_IMG_ADMIN', 'https://thaiesan.sytes.net/maxtom/img/admin/');
//define('WEB_URL_IMG_USER', 'https://thaiesan.sytes.net/maxtom/img/user/');
//define('WEB_URL_IMG_MAG', 'https://thaiesan.sytes.net/maxtom/img/mag/');
//define('WEB_URL_IMG_ICON', 'https://thaiesan.sytes.net/maxtom/img/icon/');
...
define('_I_LOGO_SIG_W', '150'); 
define('_I_LOGO_SIG_H', '150'); 
...
define('TB_PERSON_MENU','web_person_menu');
define('TB_PERSON_RESET','web_person_reset');
define('TB_PERSON_ONLINE','web_person_online');
...
define('TB_STUDENT_MENU','web_student_menu');
define('TB_STUDENT_RESET','web_student_reset');
define('TB_STUDENT_ONLINE','web_student_online');
...
define('TB_SCHOOL_CONFIG','web_school_config');
