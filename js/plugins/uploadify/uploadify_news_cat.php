...
$targetFolder = WEB_PATH_IMG_CAT; // Relative to the root

if (!empty($_FILES)) {
	$tempFile = $_FILES['Filedata']['tmp_name'];
//	$NewFile = TIMESTAMP."_".$_FILES['Filedata']['name'];
	$targetPath = $targetFolder;
	$targetFile = $targetFolder . TIMESTAMP."_".$_FILES['Filedata']['name'];
...
if ($widths > _I_MAG_W || $heights > _I_MAG_H) {
...
//				echo str_replace($_SERVER['DOCUMENT_ROOT'],'',$targetFile);
				...
				$image->output_resized(str_replace('//','/',$targetPath).TIMESTAMP."_".$_FILES['Filedata']['name']."", "JPG");
echo TIMESTAMP."_".$_FILES['Filedata']['name'];
...
//				echo str_replace($_SERVER['DOCUMENT_ROOT'],'',$targetFile);
				...
				$image->output_resized(str_replace('//','/',$targetPath).TIMESTAMP."_".$_FILES['Filedata']['name']."", "GIF");
echo TIMESTAMP."_".$_FILES['Filedata']['name'];
	...
	//			echo str_replace($_SERVER['DOCUMENT_ROOT'],'',$targetFile);
				...
				$image->output_resized(str_replace('//','/',$targetPath).TIMESTAMP."_".$_FILES['Filedata']['name']."", "PNG");
echo TIMESTAMP."_".$_FILES['Filedata']['name'];
				}
