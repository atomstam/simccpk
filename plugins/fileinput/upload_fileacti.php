...
// Define a destination
$targetFolder = WEB_PATH_FILE_ACTI; // Relative to the root
$TIMESTAMP = time();
if (empty($_FILES['input-b7']) || (strchr($_FILES['input-b7']['name'],".")!=".doc") ||(strchr($_FILES['input-b7']['name'],".")!=".docx") || (strchr($_FILES['input-b7']['name'],".")!=".xls") || (strchr($_FILES['input-b7']['name'],".")!=".xlsx") || (strchr($_FILES['input-b7']['name'],".")!=".ppt") || (strchr($_FILES['input-b7']['name'],".")!=".pptx") || (strchr($_FILES['input-b7']['name'],".")!=".pdf") ) {
//	echo json_encode(['error'=>'No files found for upload.']);
		echo json_encode('No files found for upload. Or File not format .doc .xls .pdf');
