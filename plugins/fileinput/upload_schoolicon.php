...
if(!empty($_SESSION['admin_login']) || !empty($_SESSION['stu_login']) || !empty($_SESSION['person_login'])  ){

if(!empty($_SESSION['admin_login'])){
	$Sh_code=$_SESSION['admin_school'];
} else if(!empty($_SESSION['person_login'])){
	$Sh_code=$_SESSION['person_school'];
} else if(!empty($_SESSION['stu_login'])){
	$Sh_code=$_SESSION['stu_school'];
}
// Define a destination
$targetFolder = WEB_PATH_IMG_SCHOOL; // Relative to the root
$TIMESTAMP = time();
...
if ($widths > _I_SCHOOL_W || $heights > _I_SCHOOL_H) {
