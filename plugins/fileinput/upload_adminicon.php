...
//if (empty($_FILES['avatar-1']) || (strchr($_FILES['avatar-1']['name'],".")!=".JPG") ||(strchr($_FILES['avatar-1']['name'],".")!=".jpg") || (strchr($_FILES['avatar-1']['name'],".")!=".GIF") || (strchr($_FILES['avatar-1']['name'],".")!=".gift") || (strchr($_FILES['avatar-1']['name'],".")!=".PNG") || (strchr($_FILES['avatar-1']['name'],".")!=".png") ) {
