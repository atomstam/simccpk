...
// Define a destination
$targetFolder = WEB_PATH_FILE_RE; // Relative to the root
$TIMESTAMP = time();
if (empty($_FILES['input-b8']) || (strchr($_FILES['input-b8']['name'],".")!=".doc") ||(strchr($_FILES['input-b8']['name'],".")!=".docx") || (strchr($_FILES['input-b8']['name'],".")!=".xls") || (strchr($_FILES['input-b8']['name'],".")!=".xlsx") || (strchr($_FILES['input-b8']['name'],".")!=".ppt") || (strchr($_FILES['input-b8']['name'],".")!=".pptx") || (strchr($_FILES['input-b8']['name'],".")!=".pdf") ) {
