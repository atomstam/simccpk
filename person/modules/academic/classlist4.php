...
<div class="col-xs-12 connectedSortable">
    ...
    <div class="box box-danger">
                 ...
                 <h3 class="box-title"><?php echo _heading_title_tab4; ?> (<font color="red">ทำเครื่องหมายถูกคาบที่ 1-7 หมายถึง ขาดเรียน คาบนั้นๆ</font>)</h3>
	  ...
	  <?php
		...
		@$res['num'] = $db->select_query("SELECT * FROM ".TB_STUDENT." where stu_area='".$_SESSION['person_area']."' and stu_code='".$_SESSION['person_school']."' and stu_class='".$_GET['class_id']."' and stu_cn='".$_GET['class_cn']."' and stu_suspend='0' order by id,stu_id"); 
