...
$route='academic/subj';
$year = $_REQUEST['y'];
@$res['count'] = $db->select_query("SELECT * FROM ".TB_GD_SUBJ." where subj_area='".$_SESSION['person_area']."' and subj_school='".$_SESSION['person_school']."' and subj_year='".$year."' ORDER BY id  "); 
...
?>
    <div class="box box-danger">
	  ...
	  <?php
		...
		@$res['subj'] = $db->select_query("SELECT * FROM ".TB_GD_SUBJ." where subj_area='".$_SESSION['person_area']."' and subj_school='".$_SESSION['person_school']."' and subj_year='".$year."' ORDER BY id  ");
