...
<div class="col-xs-12 connectedSortable">
    <div class="tab-pane fade active in" >
		...
		<div align="right" >
		<div class="form-group"><a href="index.php?name=statistic&file=statlogin&route=<?php echo $route;?>" class="btn btn-warning"><i class="fa fa-undo"></i>&nbsp;<?php echo _button_detail; ?></a>
		</div>
		</div>
...
<div class="col-xs-12 connectedSortable">
    ...
    <div align="right" >
    <br>
      <div class="buttons"><a href="index.php?name=statistic&file=statlogin&route=<?php echo $route;?>" class="btn btn-warning"><i class="fa fa-undo"></i>&nbsp;<?php echo _button_detail; ?></a></div>
      <br>
      </div>
    <div class="box box-warning">
      ...
      <form action="index.php?name=statistic&file=statlogin&op=delall&route=<?php echo $route;?>" method="post" enctype="multipart/form-data" id="form" class="form-inline">
		...
		$i=1;
		while (@$arr['num'] = $db->fetch(@$res['num'])){
		@$res['user'] = $db->select_query("SELECT * FROM ".TB_ADMIN." WHERE area_code ='".$_SESSION['person_area']."' and school_code='".$_SESSION['person_school']."'  and username='".@$arr['num']['ct_user']."' "); 
		@$arr['user']=$db->fetch(@$res['user']);
		@$res['count'] = $db->select_query("SELECT * FROM ".TB_ACTIVEUSER." where ct_area='".$_SESSION['person_area']."' and ct_school='".$_SESSION['person_school']."' and ct_user='".@$arr['num']['ct_user']."' "); 
		@$rows['count'] = $db->rows(@$res['count']);
		@$res['nums'] = $db->select_query("SELECT * FROM ".TB_ACTIVEUSER." where ct_area='".$_SESSION['person_area']."' and ct_school='".$_SESSION['person_school']."' and ct_user='".@$arr['num']['ct_user']."'  "); 
