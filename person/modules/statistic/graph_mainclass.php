            ...
            $(function() {
                ...
                var bar = new Morris.Bar({
					...
					<?php
						...
						@$res['Boy'] = $db->select_query("select * from ".TB_STUDENT."  where stu_area='".$_SESSION['person_area']."' and stu_code='".$_SESSION['person_school']."' and stu_sex='1' and stu_class = '".$row['class_id']."' "); 
						$rowB = $db->rows(@$res['Boy']);
						@$res['Girl'] = $db->select_query("select * from ".TB_STUDENT."  where stu_area='".$_SESSION['person_area']."' and stu_code='".$_SESSION['person_school']."' and stu_sex='2' and stu_class = '".$row['class_id']."'  "); 
