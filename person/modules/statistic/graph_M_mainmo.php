            ...
            $(function() {
                ...
                var bar = new Morris.Bar({
					...
					<?php
						...
						@$res['class'] = $db->select_query("SELECT * FROM ".TB_CHCLASS." where c_area='".$_SESSION['person_area']."' and c_code='".$_SESSION['person_school']."' group by DATE_FORMAT(c_date, '%Y-%m') order by c_date "); 
						...
						@$res['la3'] = $db->select_query("select *,count(c_stu) as LA3 from ".TB_CHCLASS."   where c_k3 like '%ลา%'   and DATE_FORMAT(c_date, '%Y-%m')='".$DD1."' and c_area='".$_SESSION['person_area']."' and c_code='".$_SESSION['person_school']."'   group by c_class "); 
						@$arr['la3'] =$db->fetch(@$res['la3']);
						@$res['la4'] = $db->select_query("select *,count(c_stu) as LA4 from ".TB_CHCLASS."   where c_k4 like '%ลา%'   and DATE_FORMAT(c_date, '%Y-%m')='".$DD1."' and c_area='".$_SESSION['person_area']."' and c_code='".$_SESSION['person_school']."'  group by c_class  "); 
						...
						@$res['op3'] = $db->select_query("select *,count(c_stu) as OP3 from ".TB_CHCLASS."  where c_ch3= '3'   and DATE_FORMAT(c_date, '%Y-%m')='".$DD1."' and c_area='".$_SESSION['person_area']."' and c_code='".$_SESSION['person_school']."'  group by DATE_FORMAT(c_date, '%Y-%m') "); 
						...
						@$res['op6'] = $db->select_query("select *,count(c_stu) as OP6 from ".TB_CHCLASS."  where c_ch6= '6'   and DATE_FORMAT(c_date, '%Y-%m')='".$DD1."' and c_area='".$_SESSION['person_area']."' and c_code='".$_SESSION['person_school']."'  group by DATE_FORMAT(c_date, '%Y-%m') "); 
