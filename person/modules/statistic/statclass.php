      ...
      <form  method="post" enctype="multipart/form-data" id="form" class="form-inline">
		...
		?>
            <tr>
              ...
              <td layout="block" style="text-align: center;"><?=StatScore_GoodClass_PerStu($_SESSION['person_area'],$_SESSION['person_school'],$arr['Cl']['clg_group'],$arr['Cl']['clg_name'],$arr['num']['stu_id']);?></td>
              <td layout="block" style="text-align: center;"><?=StatScore_BadClass_PerStu($_SESSION['person_area'],$_SESSION['person_school'],$arr['Cl']['clg_group'],$arr['Cl']['clg_name'],$arr['num']['stu_id']);?></td>
			  <td style="text-align: center;">
									...
									?>
										<tr>
										  ...
										  <td layout="block" style="text-align: center;">
												<?=StatScore_GoodClass($_SESSION['person_area'],$_SESSION['person_school'],$arr['num']['class_id'],$arr['num']['clg_name']);?>
										  </td>
										  <td layout="block" style="text-align: center;">
												<?=StatScore_BadClass($_SESSION['person_area'],$_SESSION['person_school'],$arr['num']['class_id'],$arr['num']['clg_name']);?>
										  </td>
										  <td style="text-align: center;">
