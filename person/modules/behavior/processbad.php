...
if($_POST['OP']=='Add'){
	...
	for($x=0;$x<count($_POST['Bad_stu']);$x++){
		@$res['stu'] = $db->select_query("SELECT * FROM ".TB_STUDENT." WHERE stu_area='".$_SESSION['person_area']."' and stu_code='".$_SESSION['person_school']."'  and stu_id='".$_POST['Bad_stu'][$x]."' "); 
	...
	for($y=0;$y<count($_POST['Bad_tail']);$y++){
		@$res['B'] = $db->select_query("SELECT * FROM ".TB_BADTAIL." WHERE badtail_area='".$_SESSION['person_area']."' and badtail_code='".$_SESSION['person_school']."'   and badtail_id='".$_POST['Bad_tail'][$y]."' "); 
	...
	for($xi=0;$xi<count($_POST['Bad_stu']);$xi++){
		@$res['stus'] = $db->select_query("SELECT * FROM ".TB_STUDENT." WHERE stu_area='".$_SESSION['person_area']."' and stu_code='".$_SESSION['person_school']."'  and stu_id='".$_POST['Bad_stu'][$xi]."' and stu_class='".$value."' "); 
