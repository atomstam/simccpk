...
<div class="col-xs-12 connectedSortable">
    ...
    <div class="box box-danger">
                 ...
                 <h3 class="box-title"><?php echo _heading_title_tab3; ?></h3>
	  ...
	  <?php
		...
		@$res['num'] = $db->select_query("SELECT * FROM ".TB_STUDENT." where stu_area='".$_SESSION['person_area']."' and stu_code='".$_SESSION['person_school']."' and stu_class='".$_GET['class_id']."' and stu_cn='".$_GET['class_cn']."' and stu_suspend='0' order by id"); 
        ...
        <table id="example3" class="table table-bordered table-striped responsive" style="width:100%">
          <thead>
            <tr >
              ...
              <th layout="block" style="text-align:center;" ><?php echo _text_box_table_tab3_stu_id; ?></th>
              <th layout="block" style="text-align:center;"><?php echo _text_box_table_tab3_stu_name; ?></th>
              <th layout="block" style="text-align:center;">ห้อง</th>
              <th layout="block" style="text-align:center;"><?php echo _text_box_table_tab3_status1; ?></th>
			  <th layout="block" style="text-align:center;"><?php echo _text_box_table_tab3_status2;?></th>
              <th layout="block" style="text-align:center;"><?php echo _text_box_table_tab3_status3;?></th>
            </tr>
          </thead>
          <tbody>
		<?php
