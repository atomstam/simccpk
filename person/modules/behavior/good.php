...
if($op=='del'){
		...
		$del .=$db->del(TB_GOOD," good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and good_tail='".$_GET['good_id']."' ");
		if($del){
...
if($op=='cldel'){
		...
		$del .=$db->del(TB_GOOD," good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and good_tail='".$_GET['good_id']."' and good_stu='".$_GET['stu_id']."' ");
		if($del){
		$success=_text_report_del_ok;
		} else {
		$error_warning=_text_report_del_fail;
...
if($op=='delall'){
		...
		while(list($key, $value) = each ($_POST['selected'])){
			...
			$del .=$db->del(TB_GOOD," good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and good_tail='".$value."' ");
//			$db->closedb ();
		}
		if($del){
		$success=_text_report_del_ok;
...
if($op=='cldelall'){
		...
		while(list($key, $value) = each ($_POST['selected'])){
			...
			$del .=$db->del(TB_GOOD," good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and good_stu='".$value."' and good_tail='".$_GET['good_id']."' ");
//			$db->closedb ();
		}
		if($del){
		$success=_text_report_del_ok;
...
if($op=='studel'){
		...
		$del .=$db->del(TB_GOOD," good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and good_id='".$_GET['good_id']."' ");
		if($del){
		$success=_text_report_del_ok;
		} else {
		$error_warning=_text_report_del_fail;
...
@$res['goods'] = $db->select_query("SELECT * FROM ".TB_GOOD." WHERE good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and good_id='".$_GET['good_id']."' "); 
...
@$res['good'] = $db->select_query("SELECT *,count(good_stu) as STU FROM ".TB_GOOD." WHERE good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and good_tail='".$_GET['good_id']."' and good_stu='".$_GET['stu_id']."' group by good_tail"); 
...
?>
     ...
     <button type="button" class="close" data-dismiss="alert">X</button>
	  ...
	  <?php
		...
		@$res['num'] = $db->select_query("SELECT * FROM ".TB_GOOD." as a, ".TB_STUDENT." as b where good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and good_tail='".$_GET['good_id']."' and good_stu=stu_id and good_stu='".$_GET['stu_id']."' order by good_id desc "); 
...
?>
     ...
     <button type="button" class="close" data-dismiss="alert">X</button>
	  ...
	  <?php
		...
		@$res['num'] = $db->select_query("SELECT *,count(good_stu) as CO FROM ".TB_GOOD." , ".TB_STUDENT." where good_tail='".$_GET['good_id']."'  and good_stu=stu_id and good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and stu_class='".$_SESSION['person_class']."' and stu_cn='".$_SESSION['person_cn']."'  group by good_stu order by CO desc,stu_class,stu_id "); 
		@$rows['num'] = $db->rows(@$res['num']);
		if(@$rows['num']) {
		?>
...
@$res['count'] = $db->select_query("SELECT * FROM ".TB_GOOD.", ".TB_STUDENT."  where  good_stu=stu_id and good_area='".$_SESSION['person_area']."' and good_code='".$_SESSION['person_school']."' and stu_class='".$_SESSION['person_class']."' and stu_cn='".$_SESSION['person_cn']."'   group by good_id"); 
