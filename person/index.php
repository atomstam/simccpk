...
if(empty($_SESSION['uaAd']) || $_SESSION['uaAd'] != $_SESSION['person_login'].":".$_SERVER['HTTP_USER_AGENT'].":".$IPADDRESS.":".$_SERVER['HTTP_ACCEPT_LANGUAGE'])
{
session_unset();
//session_destroy();
//session_destroy();
...
require_once("modules/person/lang/login.php");
require_once ("modules/person/login.php");
}
}
