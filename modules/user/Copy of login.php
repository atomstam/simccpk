...
$res['user'] = $db->select_query("SELECT * FROM ".TB_USER." WHERE username='".$Username."' AND password='".md5($Password)."'  "); 
...
if(!empty($arr['user']['user_id'])){
	...
	$_SESSION['ua'] = $_SESSION['user_login'].":".$_SERVER['HTTP_USER_AGENT'].":".$IPADDRESS.":".$_SERVER['HTTP_ACCEPT_LANGUAGE'].":".$_SESSION['user_code'];
	$timeoutseconds=10*60*60;
