...
//                 $("#thanks").html(msg.message),
				 ...
				 $("#error").hide();
				 setTimeout(function() {
  				 window.location='index.php?name=person&file=login&route=<?php echo $route;?>';
				}, 3000);
			} else {
...
@$res['user'] = $db->select_query("SELECT * FROM ".TB_PERSON." WHERE per_ids='".$Username."' AND perpin='".$Password."' and per_code='".$_SESSION['sh_code']."' and status='1' "); 
...
<!--
    ...
    <a href="<?=WEB_URLS;?>/index.php?name=person&file=forget">ลืมรหัสผ่าน</a> | 
