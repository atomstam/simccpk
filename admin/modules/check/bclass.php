...
if($op=='cldetail' and $action=='' ){
		...
		@$res['numchkclass'] = $db->select_query("SELECT * FROM ".TB_CHK_CHCLASS." WHERE chk_area='".$_SESSION['admin_area']."' and chk_code='".$_SESSION['admin_school']."' and chk_gr='".$_GET['gr']."' and DATE_FORMAT(chk_date, '%Y-%m') like '%".$_GET['mo_id']."%'  group by chk_class,chk_cn"); 
...
<div class="col-xs-12 connectedSortable">
      ...
      <form  method="post" enctype="multipart/form-data" id="form" class="form-inline">
		...
		$year = $CC[0]+543;
		$date=$CC[2];
		@$res['chkclass'] = $db->select_query("SELECT * FROM ".TB_CHK_CHCLASS." WHERE chk_area='".$_SESSION['admin_area']."' and chk_code='".$_SESSION['admin_school']."' and chk_gr='".$_GET['gr']."' and DATE_FORMAT(chk_date, '%Y-%m-%d') like '%".$arr['num']['c_date']."%' group by chk_class,chk_cn"); 
...
<?php
		...
		@$res['numchkclass'] = $db->select_query("SELECT * FROM ".TB_CHK_CHCLASS." WHERE chk_area='".$_SESSION['admin_area']."' and chk_code='".$_SESSION['admin_school']."' and chk_gr='".$_GET['gr']."' and DATE_FORMAT(chk_date, '%Y-%m-%d') like '%".$_GET['moid']."%' and gr='".$_GET['gr']."' group by chk_class,chk_cn"); 
		@$NumRowChkclass = $db->rows(@$res['numchkclass']);
		...
		?>
            <tr>
              ...
              <td layout="block" style="text-align: center;">
				...
				$res['chk'] = $db->select_query("SELECT * FROM ".TB_CHK_CHCLASS." WHERE chk_area='".$_SESSION['admin_area']."' and chk_code='".$_SESSION['admin_school']."' and chk_class='".$arr['num']['class_id']."' and chk_cn='".$arr['num']['clg_name']."' and chk_gr='".$_GET['gr']."' and DATE_FORMAT(chk_date, '%Y-%m-%d') like '%".$_GET['moid']."%' "); 
		...
		<div class="tab-pane fade in active" id="tab1">
				<br>
				  ...
				  <form  method="post" enctype="multipart/form-data" id="form" class="form-inline">
					...
					$get_month = $DD[1];
					$year = $DD[0]+543;
					@$res['chkclass'] = $db->select_query("SELECT *,count(chk_id) as CO  FROM ".TB_CHK_CHCLASS." WHERE chk_area='".$_SESSION['admin_area']."' and chk_code='".$_SESSION['admin_school']."' and chk_gr='1' and DATE_FORMAT(chk_date, '%Y-%m') like '%".$DD1."%' group by DATE_FORMAT(chk_date, '%Y-%m') like '%".$DD1."%'"); 
		...
		<div class="tab-pane fade in" id="tab2">
				...
				<br>
				  ...
				  <form  method="post" enctype="multipart/form-data" id="form" class="form-inline">
					...
					$get_month = $DD[1];
					$year = $DD[0]+543;
					@$res['chkclass'] = $db->select_query("SELECT *,count(chk_id) as CO  FROM ".TB_CHK_CHCLASS." WHERE chk_area='".$_SESSION['admin_area']."' and chk_code='".$_SESSION['admin_school']."' and chk_gr='2' and DATE_FORMAT(chk_date, '%Y-%m') like '%".$DD1."%' group by DATE_FORMAT(chk_date, '%Y-%m') like '%".$DD1."%'"); 
					@$arr['chkclass']= $db->fetch(@$res['chkclass']);
					?>
						<tr>
						  <td style="text-align: center;"><?php echo $i;?></td>
        ...
        <div class="tab-pane fade in" id="tab3">
				...
				<br>
				  ...
				  <form  method="post" enctype="multipart/form-data" id="form" class="form-inline">
					...
					$get_month = $DD[1];
					$year = $DD[0]+543;
					@$res['chkclass'] = $db->select_query("SELECT *,count(chk_id) as CO  FROM ".TB_CHK_CHCLASS." WHERE chk_area='".$_SESSION['admin_area']."' and chk_code='".$_SESSION['admin_school']."' and chk_gr='3' and DATE_FORMAT(chk_date, '%Y-%m') like '%".$DD1."%' group by DATE_FORMAT(chk_date, '%Y-%m') like '%".$DD1."%'"); 
					@$arr['chkclass']= $db->fetch(@$res['chkclass']);
					?>
						<tr>
						  <td style="text-align: center;"><?php echo $i;?></td>
