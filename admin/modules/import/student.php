...
if($op=='del'){
		...
		$del .=$db->del(TB_STUDENT," stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."'  and stu_id='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_BAD," bad_area='".$_SESSION['admin_area']."' and bad_code='".$_SESSION['admin_school']."' and bad_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_BESTTAIL," btail_area='".$_SESSION['admin_area']."' and btail_code='".$_SESSION['admin_school']."'  and btail_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_CHCLASS," c_area='".$_SESSION['admin_area']."' and c_code='".$_SESSION['admin_school']."' and c_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_GOOD," good_area='".$_SESSION['admin_area']."' and good_code='".$_SESSION['admin_school']."' and good_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_EXITTAIL," ext_area='".$_SESSION['admin_area']."' and ext_code='".$_SESSION['admin_school']."' and ext_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_ENTTAIL," got_area='".$_SESSION['admin_area']."' and got_code='".$_SESSION['admin_school']."' and got_sid='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_PUTTAIL," pt_area='".$_SESSION['admin_area']."' and pt_code='".$_SESSION['admin_school']."'  and pt_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_RUBRONG," rub_area='".$_SESSION['admin_area']."' and rub_code='".$_SESSION['admin_school']."' and rub_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_COUNTAIL," cot_area='".$_SESSION['admin_area']."' and cot_code='".$_SESSION['admin_school']."' and cot_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_WHITECLTAIL," whcl_area='".$_SESSION['admin_area']."' and whcl_code='".$_SESSION['admin_school']."' and whcl_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_AFFTAIL," afft_area='".$_SESSION['admin_area']."' and afft_code='".$_SESSION['admin_school']."' and afft_stu='".$_GET['stu_id']."' ");
		$del .=$db->del(TB_NUT," nut_area='".$_SESSION['admin_area']."' and nut_code='".$_SESSION['admin_school']."' and nut_stu='".$_GET['stu_id']."' ");
...
CheckAdminGroup($_SESSION['admin_login'],$_SESSION['admin_pwd'],$_SESSION['admin_group']);
		...
		while(list($key, $value) = each ($_POST['selected'])){
			...
			$del .=$db->del(TB_STUDENT," stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."'  and stu_id='".$value."' ");
			$del .=$db->del(TB_BAD," bad_area='".$_SESSION['admin_area']."' and bad_code='".$_SESSION['admin_school']."' and bad_stu='".$value."' ");
			$del .=$db->del(TB_BESTTAIL," btail_area='".$_SESSION['admin_area']."' and btail_code='".$_SESSION['admin_school']."'  and btail_stu='".$value."' ");
			$del .=$db->del(TB_CHCLASS," c_area='".$_SESSION['admin_area']."' and c_code='".$_SESSION['admin_school']."' and c_stu='".$value."' ");
			$del .=$db->del(TB_GOOD," good_area='".$_SESSION['admin_area']."' and good_code='".$_SESSION['admin_school']."' and  good_stu='".$value."' ");
			$del .=$db->del(TB_EXITTAIL," ext_area='".$_SESSION['admin_area']."' and ext_code='".$_SESSION['admin_school']."' and ext_stu='".$value."' ");
			$del .=$db->del(TB_ENTTAIL," got_area='".$_SESSION['admin_area']."' and got_code='".$_SESSION['admin_school']."' and got_sid='".$value."' ");
			$del .=$db->del(TB_PUTTAIL," pt_area='".$_SESSION['admin_area']."' and pt_code='".$_SESSION['admin_school']."'  and pt_stu='".$value."' ");
			$del .=$db->del(TB_RUBRONG," rub_area='".$_SESSION['admin_area']."' and rub_code='".$_SESSION['admin_school']."' and rub_stu='".$value."' ");
			$del .=$db->del(TB_COUNTAIL," cot_area='".$_SESSION['admin_area']."' and cot_code='".$_SESSION['admin_school']."' and cot_stu='".$value."' ");
			$del .=$db->del(TB_WHITECLTAIL," whcl_area='".$_SESSION['admin_area']."' and whcl_code='".$_SESSION['admin_school']."' and whcl_stu='".$value."' ");
			$del .=$db->del(TB_AFFTAIL," afft_area='".$_SESSION['admin_area']."' and afft_code='".$_SESSION['admin_school']."' and afft_stu='".$value."' ");
			$del .=$db->del(TB_NUT," nut_area='".$_SESSION['admin_area']."' and nut_code='".$_SESSION['admin_school']."' and nut_stu='".$value."' ");
...
<?php
//<form action="index.php?name=import&file=student&op=add&action=add&route=" method="post" //enctype="multipart/form-data" id="form" role="form" data-toggle="validator" class="form-horizontal bootstrap-validator-form" >
?>
...
//twitter bootstrap script
 $("button#submitForm").click(function(){
			$.ajax({
			type: "POST",
			url: "modules/import/processstudent.php",
...
//                 $("#thanks").html(msg.message),
				 ...
				 $("#error").hide();
				 setTimeout(function() {
  				 window.location='index.php?name=import&file=student&route=<?php echo $route;?>';
				}, 1000);
			} else {
...
$(function(){
 $("select#province").change(function(){
  var datalist2 = $.ajax({ // รับค่าจาก ajax เก็บไว้ที่ตัวแปร datalist2
     url: "modules/import/amphur.php", // ไฟล์สำหรับการกำหนดเงื่อนไข
...
$(function(){
 $("select#amphur").change(function(){
  var datalist3 = $.ajax({ // รับค่าจาก ajax เก็บไว้ที่ตัวแปร datalist3
     url: "modules/import/tambol.php", // ไฟล์สำหรับการกำหนดเงื่อนไข
  ...
  // ชื่อตัวแปร และ element ต่างๆ สามารถเปลี่ยนไปตามการกำหนด
		...
		<div align="right" ><div class="form-group"><button class="btn bg-green btn-flat" type="submit" id="submitForm" name="submitForm"><i class="fa fa-save"></i>&nbsp;<?php echo _button_save; ?></button>&nbsp;&nbsp;<a href="index.php?name=import&file=student&route=<?php echo $route;?>" class="btn bg-red btn-flat"><i class="fa fa-undo"></i>&nbsp;<?php echo _button_reset; ?></a>
		</div></div>
...
<div class="form-group">
	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="tab1">
							...
							<div class="col-sm-2"><input type="text" name="Stu_id"  class="form-control css-require" placeholder="12345" maxlength="5" data-minlength="4"  pattern="^[0-9]{1,}$" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_pid; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_pid"  class="form-control css-require" placeholder="1234567891234" maxlength="13" data-minlength="13"  pattern="^[0-9]{1,}$" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
						     <div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_num; ?></label>
							<div class="col-sm-4" >
							<input type="radio" name="Stu_num" class="minimal" value="<?php echo _text_box_table_stu_num_chai; ?>" >&nbsp;<?php echo _text_box_table_stu_num_chai;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_num" class="minimal" value="<?php echo _text_box_table_stu_num_ying; ?>" >&nbsp;<?php echo _text_box_table_stu_num_ying;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_num" class="minimal" value="<?php echo _text_box_table_stu_num_nai; ?>" >&nbsp;<?php echo _text_box_table_stu_num_nai;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_num" class="minimal" value="<?php  echo _text_box_table_stu_num_nangsaw; ?>" >&nbsp;<?php echo _text_box_table_stu_num_nangsaw;?>&nbsp;&nbsp;
							</div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_name; ?></label>
							<div class="col-sm-4"><input type="text" name="Stu_name"  class="form-control"  placeholder="Name" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_sur; ?></label>
							<div class="col-sm-4"><input type="text" name="Stu_sur"  class="form-control"  placeholder="Surname" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
							<div class="form-group" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_nick; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_nick"  class="form-control"  placeholder="Nickname"  required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
						     <div class="form-group has-feedback">
							...
							<div class="col-sm-3"><input type="email" name="Stu_email"  id="inputEmail" class="form-control"  placeholder="atom@gmail.com"><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
							<div class="form-group" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_LineId; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_LineId"  class="form-control"  placeholder="atom123"  ><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>

							<div class="form-group" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_hight; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_hight"  class="form-control"  placeholder="hight" ><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
							<div class="form-group" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_weight; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_weight"  class="form-control"  placeholder="weight"  ><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
						     <div class="form-group has-feedback">
							...
							@$res['class'] = $db->select_query("SELECT * FROM ".TB_CLASS." where class_area='".$_SESSION['admin_area']."' and class_school='".$_SESSION['admin_school']."' ORDER BY class_id ");
							...
							<input type='text' class="form-control" name="Stu_birth" class="form-control css-require">
	...
	//											alert(responsedata)
							...
							<div class="col-sm-3" >
							<input type="checkbox" name="Stu_suspend"  id="Checked" class="check" value="1" data-error="Before you wreck yourself" >
							</div>
							</div>
		</div>
		<div class="tab-pane fade in" id="tab2">
							...
							<div class="col-sm-2"><input type="text" name="Stu_add"  class="form-control css-require" placeholder="111/20" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_group; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_group"  class="form-control css-require" placeholder="10" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>   
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_ban; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_ban"  class="form-control css-require"  placeholder="nongmonpla" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							...
							<div class="col-sm-2"><input type="text" name="Stu_post"  class="form-control css-require"  placeholder="44000" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_distance; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_distn"  class="form-control"  placeholder="distance"  required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_time; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_time"  class="form-control"  placeholder="time"  required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
						     <div class="form-group has-feedback">
							...
							<div class="col-sm-3">
							Latitude  
							<input name="lat_value" type="text" id="lat_value" value="0" class="form-control"/>
							</div>
							<div class="col-sm-3">
							Longitude  
							<input name="lon_value" type="text" id="lon_value" value="0" class="form-control"/>
							</div>
							<div class="col-sm-2">
							Zoom  
							<input name="zoom_value" type="text" id="zoom_value" value="0" size="5" class="form-control"/>  
							</div>
							</div>
							<div class="form-group" >
        ...
        <div class="tab-pane fade in" id="tab3">
							...
							<div class="col-sm-3"><input type="text" name="Stu_fpid"  class="form-control css-require" placeholder="1111111111111" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_father; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_father"  class="form-control css-require" placeholder="Mr.somsong tongtip" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group" >
							...
							<div class="col-sm-3"><input type="email" name="Stu_femail"  id="inputEmail" class="form-control"  placeholder="atom@gmail.com"><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
						    <div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_fstatus; ?></label>
							<div class="col-sm-4" >
							<input type="radio" name="Stu_fstatus" class="minimal" value="<?php echo _text_box_table_stu_fmo_status_ok; ?>" >&nbsp;<?php echo _text_box_table_stu_fmo_status_ok;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_fstatus" class="minimal" value="<?php echo _text_box_table_stu_fmo_status_no; ?>" >&nbsp;<?php echo _text_box_table_stu_fmo_status_no;?>&nbsp;&nbsp;
							</div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_mpid; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_mpid"   class="form-control css-require" placeholder="2222222222222" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_marther; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_marther"  class="form-control css-require" placeholder="Miss.somjit tongtip" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group" >
							...
							<div class="col-sm-3"><input type="email" name="Stu_memail"  id="inputEmail" class="form-control"  placeholder="atom@gmail.com"><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
						    <div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_mstatus; ?></label>
							<div class="col-sm-4" >
							<input type="radio" name="Stu_mstatus" class="minimal" value="<?php echo _text_box_table_stu_fmo_status_ok; ?>" >&nbsp;<?php echo _text_box_table_stu_fmo_status_ok;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_mstatus" class="minimal" value="<?php echo _text_box_table_stu_fmo_status_no; ?>" >&nbsp;<?php echo _text_box_table_stu_fmo_status_no;?>&nbsp;&nbsp;
							</div>
							</div>
							<div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_status; ?></label>
							<div class="col-sm-9" >
							<input type="radio" name="Stu_status" class="minimal" value="<?php echo _text_box_table_stu_status_1; ?>" >&nbsp;<?php echo _text_box_table_stu_status_1;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_status" class="minimal" value="<?php echo _text_box_table_stu_status_2; ?>" >&nbsp;<?php echo _text_box_table_stu_status_2;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_status" class="minimal" value="<?php echo _text_box_table_stu_status_3; ?>" >&nbsp;<?php echo _text_box_table_stu_status_3;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_status" class="minimal" value="<?php echo _text_box_table_stu_status_4; ?>" >&nbsp;<?php echo _text_box_table_stu_status_4;?>&nbsp;&nbsp;
							<input type="radio" name="Stu_status" class="minimal" value="<?php echo _text_box_table_stu_status_5; ?>" >&nbsp;<?php echo _text_box_table_stu_status_5;?>&nbsp;&nbsp;
							</div>
							</div>

							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_opid; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_opid"  class="form-control css-require" placeholder="3333333333333" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_orther; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_orther"  class="form-control css-require" placeholder="Miss.sompong somboon" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group" >
							...
							<div class="col-sm-3"><input type="email" name="Stu_oemail"  id="inputEmail" class="form-control"  placeholder="atom@gmail.com"><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
						    <div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_ostatus; ?></label>
							<div class="col-sm-4" >
							<select  class="form-control css-require" name="Stu_ostatus" required="required">
							<option value="" selected disabled><?php echo _text_box_table_stu_ostatus_select;?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_1; ?>"><?php echo _text_box_table_stu_ostatus_1; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_2; ?>"><?php echo _text_box_table_stu_ostatus_2; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_3; ?>"><?php echo _text_box_table_stu_ostatus_3; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_4; ?>"><?php echo _text_box_table_stu_ostatus_4; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_5; ?>"><?php echo _text_box_table_stu_ostatus_5; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_6; ?>"><?php echo _text_box_table_stu_ostatus_6; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_7; ?>"><?php echo _text_box_table_stu_ostatus_7; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_8; ?>"><?php echo _text_box_table_stu_ostatus_8; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_9; ?>"><?php echo _text_box_table_stu_ostatus_9; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_10; ?>"><?php echo _text_box_table_stu_ostatus_10; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_11; ?>"><?php echo _text_box_table_stu_ostatus_11; ?></option>
								<option value="<?php echo _text_box_table_stu_ostatus_12; ?>"><?php echo _text_box_table_stu_ostatus_12; ?></option>
							</select>
							</div>
							</div>
...
@$res['user'] = $db->select_query("SELECT * FROM ".TB_STUDENT." WHERE stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."' and stu_id='".$_GET['stu_id']."'"); 
...
<div class="form-group">
	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="tab1">
							...
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_birth; ?></label>
							<div class="col-sm-3" >
							<?php $DateTimeStart=date('Y-m-d',@$arr['user']['stu_birth']);?>
							<div class="input-group date" id="dp1" data-date="<?php echo $DateTimeStart;?>" data-date-format="yyyy-mm-dd">
	...
	//											alert(responsedata)
		...
		<div class="tab-pane fade in" id="tab2">
							...
							@$res['prov'] = $db->select_query("SELECT * FROM ".TB_PROVINCE." order by id"); 
							while (@$arr['prov'] = $db->fetch(@$res['prov'])){?>
								<option value="<?php echo @$arr['prov']['id'];?>" <?php if(@$arr['prov']['id']==@$arr['user']['stu_prov']){ echo "selected ";}?>><?php echo @$arr['prov']['name'];?></option>
								<?php } ?>
								</select>
							</div>
							</div> 							
							...
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_distance; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_distn"  class="form-control"  placeholder="distance" value="<?php echo @$arr['user']['stu_distn']; ?>" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_time; ?></label>
							<div class="col-sm-2"><input type="text" name="Stu_time"  class="form-control"  placeholder="time" value="<?php echo @$arr['user']['stu_time']; ?>" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>						
							</div>
						     <div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_travel; ?></label>
							<div class="col-sm-4" >
        ...
        <div class="tab-pane fade in" id="tab3">
							...
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_opid; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_opid"  value="<?php echo @$arr['user']['stu_opid']; ?>" class="form-control css-require" placeholder="3333333333333" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_orther; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_orther"  value="<?php echo @$arr['user']['stu_orther']; ?>" class="form-control css-require" placeholder="Miss.sompong somboon" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_ophone; ?></label>
...
function initialize() { 
  if (GBrowserIsCompatible()) { 
    var map = new GMap2(document.getElementById("map_canvas")); 
	var Lat = '<?php echo @$arr["user"]["stu_lat"];?>';
	var Long = '<?php echo @$arr["user"]["stu_long"];?>';
	if(Lat ==0){
    var center = new GLatLng(16.427453128302673,103.00498033340455); // การกำหนดจุดเริ่มต้น
	} else {
    var center = new GLatLng(Lat,Long); // การกำหนดจุดเริ่มต้น
...
@$res['user'] = $db->select_query("SELECT * FROM ".TB_STUDENT." where stu_id='".$_GET['id']."' order by stu_class,stu_id"); 
@$arr['user'] = $db->fetch(@$res['user']);
...
?>
		...
		<div align="right" >
		<div class="form-group"><a href="index.php?name=import&file=student&route=<?php echo $route;?>" class="btn bg-orange btn-flat"><i class="fa fa-undo"></i>&nbsp;<?php echo _button_detail; ?></a>
		</div>
		</div>
	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="tab1">
							...
							<div class="col-sm-3"><input type="text" name="Stu_class"  class="form-control"  value="<?php echo @$arr['class']['class_name']; ?>" readonly><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>		
						     ...
						     <div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_gcolor; ?></label>
							<div class="col-sm-3"><input type="text" name="Stu_gcolor"  class="form-control"  value="<?php echo @$arr['gcolor']['gcolor_name']; ?>" readonly><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>		
							</div>
							<div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_birth; ?></label>
							<div class="col-sm-3" >
							<input type='text' class="form-control" name="Stu_birth" class="form-control css-require" value="<?php echo FullDateThai(@$arr['user']['stu_birth']); ?>" readonly>
							</div>
							</div>
							<div class="form-group" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_best; ?></label>
		...
		<div class="tab-pane fade in" id="tab2">
							...
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_stu_tum; ?></label>
								...
								@$res['tam'] = $db->select_query("SELECT * FROM ".TB_TUMBON." where id='".@$arr['user']['stu_tum']."' "); 
...
<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=AIzaSyBVi05i9Z5VUXffnl-VNIUUbgUrOqsNkiE&amp;sensor=false&amp;language=th" type="text/javascript"></script>
<?php
$Name=@$arr['user']['stu_num'].@$arr['user']['stu_name']." ".@$arr['user']['stu_sur'];
$Lat=@$arr['user']['stu_lat'];
$Long=@$arr['user']['stu_long'];
$Img=WEB_URL_IMG_STU.@$arr['user']['stu_pic']
?>
<script type="text/javascript"> 
var GGM;
var map;
...
newHouse.iconSize = new GSize(35,40);
newHouse.image = '<?php echo $Img;?>';
//alert('<?php echo $Img;?>');
function initialize() { 
...
//	var marker = new GMarker(center, {draggable: false,icon:newHouse});  
    map.addOverlay(marker);
    GGM.event.addListener(marker, 'click', function() {
        	map.openInfoWindow(center, "<img src=<?php echo $Img;?> border=0><br>"+name+"");
    });
...
<?php
} else if($op=='importdmc' and $action=='' ){
if($_SESSION['admin_group']==1){
?>
<style>
    .btn-file {
   ...
   <div class="col-md-12">
     ...
     <button type="button" class="close" data-dismiss="alert">X</button>
      <span><?php echo _text_report_add_fail; ?></span>
		...
		<div align="right" ><div class="form-group"><button class="btn btn-success" type="submit" id="submitForm" name="submitForm"><i class="fa fa-save"></i>&nbsp;<?php echo _button_save; ?></button>&nbsp;&nbsp;<a href="index.php?name=import&file=achieve&route=<?php echo $route;?>" class="btn btn-danger"><i class="fa fa-undo"></i>&nbsp;<?php echo _button_reset; ?></a>
		</div></div>
				...
				<form method="post" enctype="multipart/form-data" id="formImport" role="formImport" data-toggle="validator" class="form-horizontal bootstrap-validator-form" >
					    <div class="box box-warning" id="loading-example">
                                ...
                                <i class="glyphicon glyphicon-upload"></i>
                                    <h3 class="box-title"><?php echo _button_importdmc; ?></h3>
								<div class="box-tools pull-right">
								<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
								</button>
								<button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								...
								$(document).ready(function () {
									$("#input-b7").fileinput({
										...
										elErrorContainer: '#kv-avatar-errors-1',
										uploadUrl: '../plugins/fileinput/upload_achivfiledmc.php',
	...
	//											alert(responsedata)
							...
							<div class="form-group has-feedback" >
							<label class="col-sm-2 control-label col-sm-pad" ></label>
							<div class="col-md-6 col-sm-6 col-xs-6"><a href="../uploads/2561-2-studentInSchoolList.csv" class="btn btn-info"><i class="fa fa-file"></i>&nbsp;<?php echo _button_importdmc_filesample;?></a>
							</div>
							</div>
							<div class="form-group">
							<div class="col-sm-4" ><input type="hidden" name="OP"  value="Import">
							<br>
							</div>
							</div>
...
@$res['count'] = $db->select_query("SELECT * FROM ".TB_STUDENT." group by stu_id"); 
@$rows['count'] = $db->rows(@$res['count']);
?>
<div class="row">
<div class="col-xs-12 connectedSortable">
    ...
    <div class="box box-danger">
	  ...
	  <?php
		...
		@$res['num'] = $db->select_query("SELECT *,count(stu_id) as CO FROM ".TB_STUDENT." group by stu_class order by stu_class "); 
		@$rows['num'] = $db->rows(@$res['num']);
		if(@$rows['num']) {
		?>
      <form  method="post" enctype="multipart/form-data" id="form" class="form-inline">
		...
		@$arr['class'] =$db->fetch(@$res['class']);
		@$res['boy'] = $db->select_query("select *,count(stu_num) as Boy from ".TB_STUDENT."  where stu_sex='1' and stu_class='".@$arr['num']['stu_class']."' group by stu_class "); 
		@$arr['boy'] =$db->fetch(@$res['boy']);
		@$res['girl'] = $db->select_query("select *,count(stu_num) as Girl from ".TB_STUDENT."  where stu_sex='2' and stu_class='".@$arr['num']['stu_class']."' group by stu_class"); 
...
<?php		
		...
		@$res['num'] = $db->select_query("SELECT * FROM ".TB_STUDENT." where stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."' and stu_name like '%".$_POST['stu_name']."%'  order by stu_class,stu_id"); 
		} else {
		@$res['num'] = $db->select_query("SELECT * FROM ".TB_STUDENT." where stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."' order by stu_class,id,stu_id"); 
		}
		@$rows['num'] = $db->rows(@$res['num']);
?>
      <div class="row">
    ...
    <div align="right" >
    <br>
      <div class="buttons"><a href="index.php?name=import&file=student&op=add&route=<?php echo $route;?>" class="btn bg-aqua btn-flat"><i class="fa fa-edit"></i>&nbsp;<?php echo _button_add; ?></a><?php if($_SESSION['admin_group']==1){?>&nbsp;&nbsp;<a onclick="$('form').submit();" class="btn bg-red btn-flat"><i class="fa fa-trash-o"></i>&nbsp;<?php echo _button_del; ?></a>&nbsp;&nbsp;<a href="index.php?name=import&file=student&op=importdmc&route=<?php echo $route;?>" class="btn bg-green btn-flat"><i class="fa fa-download"></i>&nbsp;<?php echo _button_import; ?></a><?php } ?></div>
      <br>
      </div>
    <div class="box box-danger">
	...
	<?php
		if(@$rows['num']) {
	?>
      <form action="index.php?name=import&file=student&op=delall&route=<?php echo $route;?>" method="post" enctype="multipart/form-data" id="form" class="form-inline">
		...
		?>
            <tr>
              ...
              <td style="text-align: center;">
			 <a href="index.php?name=import&file=student&op=detail&id=<?php echo @$arr['num']['stu_id'];?>&route=<?php echo $route;?>" class="btn bg-green btn-flat btn-sm" ><i class="fa fa-search-plus "></i></a>
				<a href="index.php?name=import&file=student&op=edit&stu_id=<?php echo @$arr['num']['stu_id']; ?>&route=<?php echo $route;?>" class="btn bg-aqua btn-flat btn-sm"><i class="fa fa-edit "></i></a>
				<?php if($_SESSION['admin_group']==1){?>
				<a href="index.php?name=import&file=student&op=del&stu_id=<?php echo @$arr['num']['stu_id'];?>&route=<?php echo $route;?>" class="btn bg-red btn-flat btn-sm" data-confirm="<?php echo _text_box_con_delete_text;?>"><i class="fa fa-trash-o "></i></a>
				<?php } ?>
			  </td>
            </tr>
            <?php $i++;} ?>
