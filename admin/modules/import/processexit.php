...
$expArray[1]=$expArray[1];
		...
		for($i=0;$i<count($_POST['Ext_stu']);$i++){
						...
						$add .=$db->del(TB_STUDENT," stu_id='".$_POST['Ext_stu'][$i]."' ");
						$add .=$db->del(TB_BAD," bad_stu='".$_POST['Ext_stu'][$i]."' ");
						$add .=$db->del(TB_GOOD," good_stu='".$_POST['Ext_stu'][$i]."' ");						
						$add .=$db->del(TB_BESTTAIL," btail_stu='".$_POST['Ext_stu'][$i]."' ");
						$add .=$db->del(TB_COUNCILTAIL," cot_stu='".$_POST['Ext_stu'][$i]."' ");		
						$add .=$db->del(TB_MOTORTAIL," mot_stu='".$_POST['Ext_stu'][$i]."' ");
						$add .=$db->del(TB_PUTTAIL," pt_stu='".$_POST['Ext_stu'][$i]."' ");
						$add .=$db->del(TB_SPACIALTAIL," stail_stu='".$_POST['Ext_stu'][$i]."' ");
						$add .=$db->del(TB_WHITECLTAIL," whcl_stu='".$_POST['Ext_stu'][$i]."' ");
						$add .=$db->del(TB_CHCLASS," c_stu='".$_POST['Ext_stu'][$i]."' ");
		}
