...
if($_POST['OP']=='Add'){
	if( $_POST['nut_stu'] !='' && $_POST['nut_bad'] !='' && $_POST['nut_name'] !='' && $_POST['nut_dateco'] !='' && $_POST['nut_per'] !='' ){
...
//$expArray[1]=$expArray[1];
		...
		for($i=0;$i<count($_POST['nut_stu']);$i++){
						...
						"nut_area"=>"".$_SESSION['admin_area']."",
						"nut_code"=>"".$_SESSION['admin_school']."",
...
if($_POST['OP']=='bAdd'){
	if( $_POST['nut_stu'] !='' && $_POST['nut_name'] !='' && $_POST['nut_dateco'] !='' && $_POST['nut_per'] !='' ){
