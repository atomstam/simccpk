...
if($_POST['OP']=='Add'){
	...
	for($y=0;$y<count($_POST['Bad_tail']);$y++){
		@$res['B'] = $db->select_query("SELECT * FROM ".TB_BADTAIL." WHERE badtail_area='".$_SESSION['admin_area']."' and badtail_code='".$_SESSION['admin_school']."' or badtail_area='' and badtail_code=''  and badtail_id='".$_POST['Bad_tail'][$y]."' "); 
