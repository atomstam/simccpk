...
if(time() > $_SESSION['timeout'] || empty($_SESSION['admin_login']) || empty($_SESSION['admin_area']) || empty($_SESSION['admin_school']) ){
session_unset();
...
<div class="col-xs-12">
      ...
      <div class="row">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo getTotalAdmin('config' ,'student','');?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
		  <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo number_format(getTotalAdmin('score','good',''));?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo number_format(getTotalAdmin('score','bad',''));?></span>
            ...
            <div class="box-body">
              ...
              <div class="row">
				...
				<?php
					...
					@$result1 = $db->select_query("SELECT count(bad_id) as CI FROM ".TB_BAD." ,".TB_STUDENT." where stu_suspend='0' and stu_id=bad_stu and stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."' group by bad_id");
					@$result = $db->select_query("SELECT *,count(bad_id) as BOO FROM ".TB_BAD.",".TB_STUDENT." where stu_suspend='0' and stu_id=bad_stu and stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."' group by bad_tail order by BOO desc limit 4"); 
					$i=0;
				...
				<?php
					$bar=array("aqua","red","green","yellow");
					@$result2 = $db->select_query("SELECT count(good_id) as GI FROM ".TB_GOOD." ,".TB_STUDENT." where stu_suspend='0' and stu_id=good_stu  and stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."' group by good_id");
					@$result0 = $db->select_query("SELECT *,count(good_id) as GOO FROM ".TB_GOOD." ,".TB_STUDENT." where stu_suspend='0' and stu_id=good_stu and stu_area='".$_SESSION['admin_area']."' and stu_code='".$_SESSION['admin_school']."' group by good_tail order by GOO desc limit 4"); 
					$i=0;
					@$rows0=$db->rows(@$result2);
					while(@$arr0 = $db->fetch(@$result0)){
						@$result22 = $db->select_query("SELECT * FROM ".TB_GOODTAIL." where goodtail_area='".$_SESSION['admin_area']."' and goodtail_code='".$_SESSION['admin_school']."' and goodtail_id='".@$arr0['good_tail']."' ");
