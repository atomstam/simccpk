...
if($_POST['OP']=='Add'){
	if( $_POST['Best_stu'] !='' && $_POST['Stu_best'] !='' && $_POST['Btail_per'] !='' && $_POST['Btail_name'] !='' ){
		...
		@$res['stu'] = $db->select_query("SELECT * FROM ".TB_BESTTAIL." WHERE btail_area='".$_SESSION['admin_area']."' and btail_code='".$_SESSION['admin_school']."' and btail_stu='".$_POST['Best_stu'][$i]."' "); 
