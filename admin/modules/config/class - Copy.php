...
if($op=='del'){
		...
		$del .=$db->del(TB_CLASS," class_area='".$_SESSION['admin_area']."' and class_school='".$_SESSION['admin_school']."'  and class_id='".$_GET['class_id']."' ");
		if($del){
...
if($op=='delall'){
		...
		while(list($key, $value) = each ($_POST['selected'])){
			...
			$del .=$db->del(TB_CLASS," class_area='".$_SESSION['admin_area']."' and class_school='".$_SESSION['admin_school']."' and  class_id='".$value."' ");
//			$db->closedb ();
		}
		if($del){
		$success=_text_report_del_ok;
		...
		<div align="right" ><div class="form-group"><button class="btn bg-green btn-flat" type="submit" id="submitForm" name="submitForm"><i class="fa fa-save"></i>&nbsp;<?php echo _button_save; ?></button>&nbsp;&nbsp;<a href="index.php?name=config&file=class&route=<?php echo $route;?>" class="btn bg-red btn-flat"><i class="fa fa-undo"></i>&nbsp;<?php echo _button_reset; ?></a>
				...
				<form method="post" enctype="multipart/form-data" id="formAdd" role="formAdd" data-toggle="validator" class="form-horizontal bootstrap-validator-form" >
					    <div class="box box-success" id="loading-example">
							...
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_class_id; ?></label>
							<div class="col-sm-2"><input type="text" name="Class_id"  class="form-control"  placeholder="m1" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_class_Sh_name; ?></label>
							<div class="col-sm-3"><input type="text" name="Class_Sh"  class="form-control"  placeholder="Sh1" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_class_name; ?></label>
							<div class="col-sm-3"><input type="text" name="Class_name"  class="form-control"  placeholder="class1" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
						    <div class="form-group has-feedback">
...
@$res['class'] = $db->select_query("SELECT * FROM ".TB_CLASS." WHERE class_area='".$_SESSION['admin_area']."' and class_school='".$_SESSION['admin_school']."' and class_id='".$_GET['class_id']."'"); 
		...
		<div align="right" ><div class="form-group"><button class="btn bg-green btn-flat" type="submit" id="submitForm" name="submitForm"><i class="fa fa-save"></i>&nbsp;<?php echo _button_save; ?></button>&nbsp;&nbsp;<a href="index.php?name=config&file=class&route=<?php echo $route;?>" class="btn bg-red btn-flat"><i class="fa fa-undo"></i>&nbsp;<?php echo _button_reset; ?></a>
				...
				<form method="post" enctype="multipart/form-data" id="formEdit" role="formEdit" data-toggle="validator" class="form-horizontal bootstrap-validator-form" >
					    <div class="box box-info" id="loading-example">
							...
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_class_id; ?></label>
							<div class="col-sm-2"><input type="text" name="Class_id"  class="form-control"  value="<?php echo @$arr['class']['class_id'];?>" placeholder="m1" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_class_Sh_name; ?></label>
							<div class="col-sm-3"><input type="text" name="Class_Sh"  class="form-control"  value="<?php echo @$arr['class']['class_short'];?>" placeholder="Sh1" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
							<div class="form-group has-feedback" >
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_class_name; ?></label>
							<div class="col-sm-3"><input type="text" name="Class_name"  class="form-control"  value="<?php echo @$arr['class']['class_name'];?>" placeholder="class1" required><span class="glyphicon form-control-feedback" aria-hidden="true"></span></div>
							</div>
						    <div class="form-group has-feedback">
							<label class="col-sm-3 control-label" ><?php echo _text_box_table_tech; ?></label>
							<div class="col-sm-6" >
							...
							<div class="form-group">
							<div class="col-sm-4" ><input type="hidden" name="OP"  value="Edit"><input name="CLID" type="hidden" value="<?php echo @$arr['class']['class_id'];?>">
							<br>
							</div>
							</div>
...
<div class="col-xs-12 connectedSortable">
    ...
    <div class="box box-danger">
	  ...
	  <?php
		...
		@$res['num'] = $db->select_query("SELECT * FROM ".TB_CLASS." where class_area='".$_SESSION['admin_area']."' and class_school='".$_SESSION['admin_school']."' order by class_id"); 
      ...
      <form action="index.php?name=config&file=class&op=delall&route=<?php echo $route;?>" method="post" enctype="multipart/form-data" id="form" class="form-inline">
        <table id="example1" class="table table-bordered table-striped responsive" style="width:100%">
          <thead>
            <tr >
              ...
              <th layout="block" style="text-align:center;" ><?php echo _text_box_table_class_id; ?></th>
		...
		@$res['stu'] = $db->select_query("SELECT * FROM ".TB_STUDENT." WHERE stu_class='".@$arr['num']['class_id']."' "); 
		@$rowsSTU=$db->rows(@$res['stu']);
		?>
            <tr>
              <td style="text-align: center;"><input type="checkbox" name="selected[]" value="<?php echo @$arr['num']['class_id']; ?>" class="selector flat"/></td>
			  ...
			  <?php
		@$res['cat'] = $db->select_query("SELECT * FROM ".TB_CLASS_PERSON." WHERE clper_class='".@$arr['num']['class_id']."' order by clper_id"); 
		...
		?>		  
              ...
              <td layout="block" style="text-align: center;"><?php echo @$arr['num']['class_LineId'];?></td>
...
?>
				...
				<a href="index.php?name=config&file=class&op=del&class_id=<?php echo @$arr['num']['class_id'];?>&route=<?php echo $route;?>" class="btn bg-red btn-flat btn-sm" data-confirm="<?php echo _text_box_con_delete_text;?>"><i class="fa fa-trash-o "></i></a>
			  </td>
            </tr>
