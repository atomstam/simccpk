...
if($_POST['OP']=='Add'){
	if( $_POST['co_point'] !='' && $_POST['co_name'] !='' ){
//		$Avatar=$_FILES['avatar-1']['name'];
		$db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
		$add .=$db->add_db(TB_COUNCIL,array(
			"co_area"=>"".$_SESSION['admin_area']."",
			"co_code"=>"".$_SESSION['admin_school']."",
//			"co_id"=>"".$_POST['co_id']."",
			"co_name"=>"".$_POST['co_name']."",
			"co_point"=>"".$_POST['co_point']."",
		));
	} else {
		$add .='';
	}
...
if($_POST['OP']=='Edit'){
	if( $_POST['CLID'] !='' && $_POST['co_point'] !='' && $_POST['co_name'] !='' ){//		$Avatar=$_FILES['avatar-1']['name'];
		$db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
		$edit .=$db->update_db(TB_COUNCIL,array(
			"co_area"=>"".$_SESSION['admin_area']."",
			"co_code"=>"".$_SESSION['admin_school']."",
			"co_name"=>"".$_POST['co_name']."",
			"co_point"=>"".$_POST['co_point']."",
