<?php
// header
define('_heading_title', 'ข้อมูลพฤติกรรมนักเรียน');
...
// detail gen
define('_text_box_header_gen', 'ข้อมูลพฤติกรรมนักเรียน');
...
define('_text_report_add_ok', 'เพิ่มข้อมูลพฤติกรรมนักเรียนเรียบร้อยแล้ว');
define('_text_report_add_fail', 'ไม่สามารถเพิ่มข้อมูลพฤติกรรมนักเรียนเข้าระบบได้');

define('_text_report_del_ok', 'ลบข้อมูลพฤติกรรมนักเรียนเรียบร้อยแล้ว');
define('_text_report_del_fail', 'ไม่สามารถลบข้อมูลพฤติกรรมนักเรียนได้');
define('_text_report_del_null_fail', 'ไม่มีข้อมูลที่จะลบ');

define('_text_report_edit_ok', 'แก้ไขข้อมูลพฤติกรรมนักเรียนเรียบร้อยแล้ว');
define('_text_report_edit_fail', 'ไม่สามารถแก้ไขข้อมูลพฤติกรรมนักเรียนได้');
...
define('_text_add_tab3_badtail_name_sai', 'มาเข้าร่วมกิจกรรมหลังเลิกเรียน');


// tab4
define('_text_box_table_tab4_stu_id', 'รหัสนักเรียน');
define('_text_box_table_tab4_stu_name', 'ชื่อนักเรียน');
define('_text_box_table_tab4_sec1', 'คาบ1');
define('_text_box_table_tab4_sec2', 'คาบ2');
define('_text_box_table_tab4_sec3', 'คาบ3');
define('_text_box_table_tab4_sec4', 'คาบ4');
define('_text_box_table_tab4_sec5', 'คาบ5');
define('_text_box_table_tab4_sec6', 'คาบ6');
define('_text_box_table_tab4_sec7', 'คาบ7');
define('_text_box_table_tab4_kad', 'ขาดเรียน');
define('_text_box_table_tab4_la', 'ลา');
define('_text_box_table_tab4_value_sec1', 'หนีเรียนคาบที่1');
define('_text_box_table_tab4_value_sec2', 'หนีเรียนคาบที่2');
define('_text_box_table_tab4_value_sec3', 'หนีเรียนคาบที่3');
define('_text_box_table_tab4_value_sec4', 'หนีเรียนคาบที่4');
define('_text_box_table_tab4_value_sec5', 'หนีเรียนคาบที่5');
define('_text_box_table_tab4_value_sec6', 'หนีเรียนคาบที่6');
define('_text_box_table_tab4_value_sec7', 'หนีเรียนคาบที่7');
define('_text_box_table_tab4_value_kad', 'ไม่มาโรงเรียน');
define('_text_box_table_tab4_value_la', 'ลาโรงเรียน');
