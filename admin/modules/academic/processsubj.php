...
if($_POST['OP']=='Import'){
	...
	if( $_SESSION['admin_area'] !='' && $_SESSION['admin_school'] !='' && $_POST['P_year'] !='' && $_POST["Icon"] !='' && $_POST["Icon2"] !=''){
...
//			$dob = mysqli_real_escape_string($connection,$data->sheets[$i]['cells'][$j][4]);
		  ...
		  $Subj=mb_substr($Subjcode,0,1, "utf-8");
			...
			"subj_area"=>"".$_SESSION['admin_area']."",
			"subj_school"=>"".$_SESSION['admin_school']."",
//			"subj_code" =>"".$_SESSION['admin_school']."",
			"subj_pin" =>"".$Subjcode."",
			"subj_name" =>"".$SubjName."",
			"subj_order" =>"".$Cl."",
			"subj_year" =>"".$YY."",
			"subj_term" =>"".$Term."",
//			"subj_group" =>"".$_SESSION['admin_school']."",
			"subj_unit" =>"".$Credit."",
			"subj_hours" =>"".$Hr."",
//			"subj_midterm"=>"".$_SESSION['admin_school']."",
//			"subj_final" =>"".$_SESSION['admin_school']."",
			"subj_teach" =>"".$Teach_code."",
			));
			@$res['teach'] = $db->select_query("SELECT * FROM ".TB_GD_TEACH." where teach_area='".$_SESSION['admin_area']."' and teach_school='".$_SESSION['admin_school']."' and teach_pin='".$Teach_code."'  ");
			@$rows['teach'] = $db->rows(@$res['teach']);
			if(!@$rows['teach']){
			$Teach_Full=$Teach_num."".$Teach_name." ".$Teach_sur;
			$import .=$db->add_db(TB_GD_TEACH,array(
			"teach_area"=>"".$_SESSION['admin_area']."",
			"teach_school"=>"".$_SESSION['admin_school']."",
...
//			"subj_final" =>"".$_SESSION['admin_school']."",
			...
			@$res2['teach'] = $db->select_query("SELECT * FROM ".TB_GD_TEACH." where teach_area='".$_SESSION['admin_area']."' and teach_school='".$_SESSION['admin_school']."' and teach_pin='".$Teach_code2."'  ");
...
if($_POST['OP']=='Add'){
	if( $_SESSION['admin_area'] !='' && $_SESSION['admin_school'] !='' && $_POST['P_year'] !='' && $_POST['CodePin'] !='' $_POST['Name'] !='' && $_POST['Class'] !='' && $_POST['Term'] !='' && $_POST['Unit'] !='' && $_POST['Hours'] !='' && $_POST['Teach'] !=''){ //		$Avatar=$_FILES['avatar-1']['name'];
...
if($_POST['OP']=='Edit'){
	if( $_SESSION['admin_area'] !='' && $_SESSION['admin_school'] !='' && $_POST['P_year'] !='' && $_POST['CodePin'] !='' $_POST['Name'] !='' && $_POST['Class'] !='' && $_POST['Term'] !='' && $_POST['Unit'] !='' && $_POST['Hours'] !='' && $_POST['Teach'] !='' && $_POST['ID'] !=''){ //		$Avatar=$_FILES['avatar-1']['name'];
