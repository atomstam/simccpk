...
if(empty($_SESSION['uaAd']) || $_SESSION['uaAd'] != $_SESSION['admin_login'].":".$_SERVER['HTTP_USER_AGENT'].":".$IPADDRESS.":".$_SERVER['HTTP_ACCEPT_LANGUAGE'])
{
session_unset();
//session_destroy();
//session_destroy();
setcookie("adminlogin");
setcookie("admingroup");
setcookie("adminpwd");
...
require_once("modules/admin/lang/login.php");
