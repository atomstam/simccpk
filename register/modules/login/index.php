...
?>
 ...
 //                       $("#showFile").append('<input type=hidden name=icon value='+file.name+'>');
		...
		<div class="buttons" align="right" ><a onclick="$('#form').submit();" class="btn bg-green btn-flat btn-sm" ><i class="fa fa-save"></i>&nbsp;<?php echo _button_save; ?></a>&nbsp;&nbsp;<a href="index.php?name=admin&file=index&route=<?php echo $route;?>" class="btn bg-red btn-flat"><i class="fa fa-undo"></i>&nbsp;<?php echo _button_reset; ?></a>&nbsp;&nbsp;
		</div>
		<br>
<div class="row">
   <div class="col-xs-12 connectedSortable">
...
<div class="col-xs-12 connectedSortable">
    ...
    <div align="right" >
    <br>
      <div class="buttons"><a onclick="$('form').submit();" class="btn bg-red btn-flat btn-sm"><i class="fa fa-edit"></i>&nbsp;<?php echo _button_edit; ?></a>&nbsp;&nbsp;</div>
      <br>
      </div>
