...
$fontname = 'font/thsarabunnew-webfont.ttf';
// controls the spacing between text
$i=30;
//JPG image quality 0-100
$quality = 90;

//chmod($image_path,0777); // change file permissions 
function create_image($user){
		...
		$image_path="covers/";
		//readfile($image_path); 
		$file = $image_path.md5($user[0]['name'].$user[1]['name'].$user[2]['name']).".jpg";	
...
<input name="submit" type="submit" class="btn bg-aqua btn-flat" value="Update Image" />
</form>
</div>
